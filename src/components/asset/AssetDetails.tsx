...
export function AssetDetails({
  ...
  return (
    <div className="h-full border-l border-border bg-card/50 flex flex-col">
      ...
      {/* Tabs */}
      <Tabs defaultValue="diary" className="flex-1 flex flex-col">
        ...
        {/* Diary Tab */}
        <TabsContent value="diary" className="flex-1 flex flex-col p-4 overflow-hidden">
          {/* New Entry Form */}
        ...
        {/* Reminders Tab */}
        <TabsContent value="reminders" className="flex-1 flex flex-col p-4 overflow-hidden">
          {/* New Reminder Form */}
          <div className="space-y-2 mb-4">
            <Input
