...
const Index = () => {
  ...
  const offlineStatusMessage = !isOnline
    ? selectedAsset
      ? 'Εκτός σύνδεσης: μπορείς να διαβάσεις το ιστορικό του στοιχείου, αλλά όχι να στείλεις νέα μηνύματα ή φωνητικά.'
      : 'Εκτός σύνδεσης: μπορείς να διαβάσεις παλιές συνομιλίες και τον αποθηκευμένο καιρό, αλλά όχι να στείλεις νέα μηνύματα.'
    : undefined;
